...
Para construir la tabla dinámica con los datos recibidos por websocket utilizar alguno de los motores de plantillas vistos hasta el momento (handlebars, pug o ejs) en el frontend. Considerar usar archivos públicos para alojar la plantilla vacía.
